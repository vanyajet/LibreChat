...
export default {
  ...
  com_endpoint_preset_copy: '(Copy)',
  com_endpoint_preset_duplicate: 'Duplicate preset',
  com_endpoint_preset_set_default: 'Set preset as default',
  com_endpoint_preset_copied: 'Сopied!',
  ...
  com_nav_transactions: 'Transactions',
  com_nav_transactions_empty: 'No transactions yet',
  com_nav_transactions_orderId: 'Order №',
  com_nav_transactions_amount: 'Аmount',
  com_nav_transactions_status: 'Status',
  com_nav_transactions_createdAt: 'Created at',
  com_nav_transactions_description: 'Description',
  com_nav_transactions_status_pending: 'Pending',
  com_nav_transactions_status_initialized: 'Initialized',
  com_nav_transactions_status_confirmed: 'Confirmed',
  com_nav_transactions_status_canceled: 'Canceled',
  com_nav_transactions_status_rejected: 'Rejected',
  com_nav_transactions_status_expired: 'Expired',
  ...
  com_payment_title: 'Top up balance',
  com_payment_amount: 'Amount, ₽.',
  com_payment_min_amount: 'Minimum amount is 50₽.',
  com_payment_pay: 'Pay',
  com_payment_description: 'You will be redirected to payment page, if that did not happen automatically follow the link below',
  com_payment_close_confirm: 'Are you sure you want to close the payment window? The payment link will be lost.',
  com_payment_success: 'You will be redirected to payment page',
  com_payment_error: 'Error occured while processing payment, try again',
