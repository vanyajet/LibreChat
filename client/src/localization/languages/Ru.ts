...
export default {
  ...
  com_terms_of_use_13:
    'profi.ai оставляет за собой право деактивировать аккаунт пользователя в случае мошеннических действий, совершенных пользователем за время существования profi.ai.',
  ...
  com_terms_of_use_16:
    'создание различных учетных записей с целью многократного использования бонусов profi.ai;',
  com_terms_of_use_17:
  ...
  com_terms_of_use_19:
    'Наши пользователи имеют полное право собственности и авторские права на все дизайны, загруженные на наш сайт, страницы profi.ai в социальных сетях и электронные письма, созданные нашими пользователями. Мы никогда не будем получать доступ или просматривать любые электронные письма, созданные нашими пользователями, без их согласия.',
  // com_terms_of_use_19_1: 'Интеллектуальная собственность',
  // com_terms_of_use_19_2: 'Сервис и его оригинальное содержание, возможности и функциональность являются и будут оставаться исключительной собственностью profi.ai и его лицензиаров. Сервис защищен авторским правом, торговой маркой и другими законами зарубежных стран. Наши торговые марки и фирменный стиль не могут быть использованы в связи с каким-либо продуктом или услугой без предварительного письменного согласия profi.ai.',
  com_terms_of_use_20: '3. Ссылки на другие веб-сайты ',
  com_terms_of_use_21:
    'Наш сервис может содержать ссылки на сторонние веб-сайты или сервисы, которые не принадлежат и не контролируются profi.ai. profi.ai не контролирует и не несет ответственности за содержание, политику конфиденциальности или практику сторонних сайтов или служб. Вы также признаете и соглашаетесь, что profi.ai не несет ответственности, прямой или косвенной, за любой ущерб или потери, вызванные или предположительно вызванные использованием или в связи с использованием или доверием к любому такому содержанию, товарам или услугам, доступным на или через любые такие сайты или услуги. Мы настоятельно рекомендуем вам ознакомиться с положениями и условиями и политикой конфиденциальности любых сторонних веб-сайтов или услуг, которые вы посещаете.',
  ...
  com_terms_of_use_27_2:
    'Ни при каких обстоятельствах profi.ai, ни его директора, сотрудники, партнеры, агенты, поставщики или филиалы не несут ответственности за любые косвенные, случайные, специальные, последующие или штрафные убытки, включая, без ограничения, потерю прибыли, данных, использования, деловой репутации или других нематериальных потерь, возникших в результате',
  com_terms_of_use_28:
