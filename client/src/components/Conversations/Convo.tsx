      ...
      <a
        ...
        className={cn(
          isActiveConvo || isPopoverActive
            ? 'group w-full relative mt-2 flex cursor-pointer items-center gap-2 break-all rounded-lg bg-blue-400 px-2 py-2 active:opacity-50 dark:bg-gray-700'
            : 'group w-full relative mt-2 flex grow cursor-pointer items-center gap-2 overflow-hidden whitespace-nowrap break-all rounded-lg px-2 py-2 hover:bg-blue-200 active:opacity-50 dark:hover:bg-gray-700',
